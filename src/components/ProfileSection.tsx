...
const ProfileSection: FC = props => {
    ...
    const onDragOver: DragEventHandler<HTMLDivElement> = (event) => {
        ...
        const afterElement: Element | undefined = getDraggableAfterElement(profileSectionDiv.current, event.clientY);
    ...
    const getDraggableAfterElement = (container: HTMLDivElement, y: number) : Element | undefined => {
        ...
        return draggableElements.reduce((previousResult: AfterElementReducerResult, currentElement: Element) => {
